 ...
 * @version $$
 */
public class ClassPathStylesheetResource        extends StaticResource {
    private final static Log log = LogFactory.getLog(ClassPathStylesheetResource.class);
    ...
    protected final InputStream getResourceStream() {
        ...
        // Here we filter our CSS file and replace class path references with
        // abolsute URLs generated by externalizer
    ...
    protected LimitedBuffer bufferResource() throws IOException {
        try {
            ...
            log.error("Unable to retrieve '"+resourceFileName+"' itself or a contained classpath reference in it.");
            throw e;
        }
    }
}

...
public class SortTableCG implements org.wings.plaf.SortTableCG, SConstants
{
	...
	sortTable.add(new SCellRendererPane());
	installCellRenderer(sortTable);
    }
    public void uninstallCG(SComponent c) {
	SSortTable sortTable = (SSortTable)c;
	SCellRendererPane rendererComponent = getCellRendererPane(sortTable);
	sortTable.remove(rendererComponent);
    ...
    protected SCellRendererPane getCellRendererPane(SSortTable sortTable) {
	int count = sortTable.getComponentCount();
	for (int i=0; i < count; i++) {
	    SComponent component = sortTable.getComponent(i);
	...
	SCellRendererPane rendererPane = getCellRendererPane(sortTable);

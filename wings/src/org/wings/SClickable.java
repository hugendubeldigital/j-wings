    ...
    implements ClickableRenderComponent
{
     ...
     * the anchor in the AnchorRenderStack is rendered
     */
    private RequestListener requestTarget;
     ...
     * the anchor in the AnchorRenderStack is rendered
     */
    public final void setEvent(String event, RequestListener requestTarget) {
        setEvent(event);
    ...
    /**
     * sets the RequestListener for which to create a event.
     */
    public void setRequestTarget(RequestListener t) {
     ...
     * the anchor in the AnchorRenderStack is rendered
     */
    public final RequestListener getRequestTarget() {

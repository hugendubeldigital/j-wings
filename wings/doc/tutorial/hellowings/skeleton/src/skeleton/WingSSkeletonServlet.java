...
/**
 * <em>WingSSkeletonServlet.java</em>
 * <p>Creates very simple session servlets.</p>
 * <b><p>Created 2002, mercatis GmbH</p></b>
 **/
public class WingSSkeletonServlet extends WingServlet {
	...
	// setting the plaf to thye session
        session.getCGManager().setLookAndFeel("xhtml/css1");

	// tell the sessionmanager that we have a session
	SessionManager.setSession( session );

	// return a new WingSSkeletonSession
	return new WingSSkeletonSession ( SessionManager.getSession() );
    }

}// WingSSkeletonServlet

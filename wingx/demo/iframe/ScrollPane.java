...
import org.wings.plaf.xhtml.css1.*;
    ...
    implements SConstants
{
    ...
    public ScrollPane()
    {
        SFrame frame = new SFrame("ScrollPane");
        Session session = SessionManager.getSession();
        // session.getExternalizeManager().addObjectHandler(new DeviceObjectHandler("text/html", "html"));
        session.getCGManager().setLookAndFeel(
            new org.wings.plaf.xhtml.css1.CSS1LookAndFeel());

        SScrollPane innerScrollPane = new SScrollPane(tree1);
        innerScrollPane.setCG(new IFrameScrollPaneCG());
        innerScrollPane.setHorizontalExtent(270);
        innerScrollPane.setVerticalExtent(300);

        SScrollPane scrollPane = new SScrollPane(tree2);
        scrollPane.setVerticalAlignment(TOP_ALIGN);
        frame.getContentPane().setLayout(new SGridLayout(2));
        frame.getContentPane().add(new SLabel("inner frame scrollpane"));
        frame.getContentPane().add(new SLabel("default scrollpane"));
        frame.getContentPane().add(innerScrollPane);
    ...
    private TreeNode generateTree() {
        ...
        // Brahms
        category.add(composer = new DefaultMutableTreeNode("Brahms"));
        composer.add(style = new DefaultMutableTreeNode("Concertos"));
        ...
        // Mozart
        category.add(composer = new DefaultMutableTreeNode("Mozart"));
        composer.add(style = new DefaultMutableTreeNode("Concertos"));
        ...
        category.add(composer = new DefaultMutableTreeNode("Schubert"));
        composer.add(style = new DefaultMutableTreeNode("Quartets"));
        ...
        // Jazz
        top.add(category = new DefaultMutableTreeNode("Jazz"));

        // Ayler
        category.add(composer = new DefaultMutableTreeNode("Albert Ayler"));
        ...
        // Chet Baker
        category.add(composer = new DefaultMutableTreeNode("Chet Baker"));
        ...
        // Coltran
        category.add(composer = new DefaultMutableTreeNode("John Coltrane"));
        ...
        // Miles
        category.add(composer = new DefaultMutableTreeNode("Miles Davis"));
        ...
        // Rock
        top.add(category = new DefaultMutableTreeNode("Rock"));

        // The Beatles
        category.add(composer = new DefaultMutableTreeNode("The Beatles"));
        ...
        // Crowded House
        category.add(composer = new DefaultMutableTreeNode("Crowded House"));
        ...
        // Harvin Garvel
        category.add(composer = new DefaultMutableTreeNode("Harvin Garvel"));
        ...
        category.add(composer = new DefaultMutableTreeNode("Steve Miller Band"));
